...
## Functions and Applications
  ...
  - [4 SDK Development Methods](4-FunctionsAndApplications/6-SDKDevelopment/README.md)
    ...
    - [4.3 Based on serial communication usage](4-FunctionsAndApplications/6-SDKDevelopment/5.5-DevelopmentBasedOnCommunicationProtocolPackage/Serial_communication.md)
