# MyController S570 控制 AGV+280M5 程序案例

### 将外骨骼通过 USB 的方式连接上 AGV 上的 Jetson Nano 系统, 并保存运行以下脚本文件。

> **注意：确保每个串口号对应的设备是正确的**
>
> **启动该案例建议使用: atom 版本为 6.5; pymycobot 版本为 3.6.8**
